...
/*!
    ...
    \brief Constants used in SRS processing: indicates the Gen mode
*/
enum bblib_srs_proc_gen_mode {
        BBLIB_4th_GEN = 1, /*!< SRS processing on 4th gen hardware */
        BBLIB_NEXT_GEN = 2 /*!< SRS processing on next gen hardware */
};
