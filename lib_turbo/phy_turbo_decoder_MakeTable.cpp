                                          ...
                                          _TurboInterleaver *p)
{
    ...
    int32_t i, j, re;
    FILE * fp;
    char interleavertable[] = "lib_turbo/TurboInterleaver.dat";
...
int32_t init_common_tables(char *pTabelPath)
{
    ...
    struct tableItem tables[TABLE_NR] = {
             {g_Kidx_K_Nmaxrep_shuf_sdk, sizeof(g_Kidx_K_Nmaxrep_shuf_sdk), "lib_turbo/kidx_k_nmaxrep_shuf.bin"},
             {g_OutputWinTable8_sdk, sizeof(g_OutputWinTable8_sdk), "lib_turbo/output_win_table8.bin"},
        };
