...
int32_t init_rate_matching_lte_sse()
{
    ...
    char file_nNum_NULL[100] = "lib_rate_matching/phy_rate_match_nnum_null.bin";
    char file_nIndex_NULL[100] = "lib_rate_matching/phy_rate_match_nindex_null.bin";
    char file_ratetable[100] = "lib_rate_matching/phy_rate_match_ratetable.bin";
    ...
    const char* dir_sdk = "/home/yyj/turbo_dec/";
    if( dir_sdk == NULL )
    {
